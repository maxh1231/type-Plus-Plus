...
db.once('open', async () => {
    ...
    const badgeData = [
        ...
        // Accuracy 
        { badgeName: 'Sharp Shooter', description: 'Scored 80% Accuracy', placeholder: '/assets/badges/placeholder-accuracy-badge-1.png', img: '/assets/badges/accuracy-badge-1.png', targetVal: 80, category: 'accuracy', xp: 5, createdAt: Date.now },
        { badgeName: 'Precision Expert', description: 'Scored 90% Accuracy', placeholder: '/assets/badges/placeholder-accuracy-badge-2.png', img: '/assets/badges/accuracy-badge-2.png', targetVal: 90, category: 'accuracy', xp: 10, createdAt: Date.now },
        { badgeName: 'Perfect!', description: 'Scored 100% Accuracy', placeholder: '/assets/badges/placeholder-accuracy-badge-3.png', img: '/assets/badges/accuracy-badge-3.png', targetVal: 100, category: 'accuracy', xp: 15, createdAt: Date.now },
        // Log In Streak
