...
const WeeklyLeaderBoard = () => {
    ...
    return (
        <>
            <h1 className='block text-center text-2xl'>Weekly Leaderboard</h1>
                ...
                {leaderBoard ? (
                    <tbody>
                        {leaderBoard.map((score, i) => (
                            <tr key={uuid()}>
                                <td className='text-center' key={uuid()}>{i + 1}</td>
                                <td className='text-center' key={uuid()}>{score.wpm}</td>
                                ...
                                <td className='text-center' key={uuid()}>{score.accuracy}</td>
                                <td className='text-center' key={uuid()}>{score.date}</td>
                            </tr>
                        ))}
                    </tbody>
                ) : (
